...
| Название      | Неправильно настроен CORS в приложении Ваш кошелек |
| ----------- | ----------- |
...
| _      | Приложение не выполняет требования безопасности, присутствует IDOR-уязвимость |
| ----------- | ----------- |
| Приоритет | В работе |
| Дата создания | 12.12.2022 |
| Статус | Открыт |
| Название      | На сайте присутствует IDOR-уязвимость, из-за которой злоумышленник может получить доступ к данным организаций других пользователей |
